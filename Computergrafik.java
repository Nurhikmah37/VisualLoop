 ...
 * @author Nurhikmah
 */
public class Computergrafik extends Application implements Runnable {
    ...
    private void update() {
        ...
        if(inputKeyboard.contains("R")){//rotasi kotak se arah gerakan jarum jam  saat key R ditekan
            sudutRotasi+=2;
        }
    }
    ...
    private void draw() {
        try {
            if (canvas != null) {
                ...
                //CONTOH MENGGAMBAR KOTAK YANG DAPAT DI ROTASI
                gc.save();
                gc.translate(cx, cy);
